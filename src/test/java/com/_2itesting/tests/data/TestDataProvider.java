...
public class TestDataProvider {
    ...
    public static List<TestData> getDiscountTestData() {
        ...
        testDataList.add(new TestData(
                ...
                "John", "Doe", "Test Street", "Suite 100",
                "Manchester", "Greater Manchester", "M1 1AA", "07123456789", 15
        ));
    ...
    public static List<TestData> getCheckoutTestData() {
        ...
        testDataList.add(new TestData(
                "luis.hueso@2.com", "luis.hueso", "Polo", "2idiscount",
                "Alice", "Smith", "123 Main St", "Apt 4B",
                "Birmingham", "West Midlands", "B1 1HQ", "07111222333", 25
        ));
